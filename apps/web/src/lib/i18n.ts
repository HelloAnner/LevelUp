...
export const dictionaries = {
  'zh-CN': {
    ...
    app: {
      ...
      loginHint: '回车继续',
      loginLead: '先留一个称呼。后面这段路，我会沿着时间把它记住。',
      loginSupport: '本地开发环境支持直接输入名字，不必是真邮箱。',
      loginContinue: '进入',
    ...
    onboarding: {
      ...
      hello: '你好，{name}。',
      helloFallback: '朋友',
      introCopy: '先留一个称呼。这样后面每一句话，都能稳稳落在你身上。',
      line1: '我会陪你走过其中一小段路。',
      line2: '开始之前，我想先听清一件事。',
  ...
  'en-US': {
    ...
    app: {
      ...
      loginLead: 'Leave one name first. I will remember the road ahead through it.',
      loginSupport: 'In local development, a plain name is enough. It does not need to be a real email.',
      loginContinue: 'Enter',
    ...
    onboarding: {
      ...
      introCopy: 'Leave one name first. That way every line that follows can land somewhere real.',
